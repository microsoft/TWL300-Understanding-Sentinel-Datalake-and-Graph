...
1. Run the following query:
    ...
    {: .important } `bin()` improves performance and readability in both Sentinel and Data Lake queries.

    {: .note }Aggregating early reduces billable scan and joins run on summaries instead of raw events. 
