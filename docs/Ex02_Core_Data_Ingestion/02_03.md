...
1. On the **Role assignments** tab, review the list of users, groups, and service principals who already have access.   
    ...
    {: .important }If you’d like to export the current list, you can use the **Download role assignments (.csv)** link at the top of the page. This step is optional and for reference only.   
    > 
    >![b3.png](../../media/b3.png) 

 

    {: .warning }If your lab environment does not include a secondary user account, review the remaining steps conceptually.   
    > 
...
4. Validate access in the Defender portal. 
    ...
    1. Confirm the user can see the Sentinel Workspace (**law-sentinel-xdr-lab**)  
        ...
        {: .important }The user will not see the previously generated EICAR incident because it originated from Defender for Endpoint, and the user does not have Defender XDR permissions (Security Reader/Operator/Admin).
