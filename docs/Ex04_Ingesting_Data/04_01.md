...
1. Wait until the solution status shows **Installed**. 
    ...
    {: .note }This installs the connector, workbooks, and analytic rules. 
...
{: .warning }If no results appear, allow **5–15 minutes** for data propagation to the Data Lake and come back to retry the query. 
