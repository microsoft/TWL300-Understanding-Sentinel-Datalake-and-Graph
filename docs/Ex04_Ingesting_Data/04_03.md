...
1. Deploy the template using PowerShell. 
    ...
    {: .note } If you work with multiple Azure tenants or subscriptions, verify that you are signed in to the correct tenant and have the intended subscription selected before running any PowerShell commands. This helps prevent commands from being executed in the wrong environment. 
    ...
    1. Copy and paste the code from the Notepad editor into the PowerShell 7 terminal and execute it. 
        ...
        {: .warning } If you get an error just rerun the script until it’s successful. 
...
1. Monitor data ingestion.
    ...
    1. Run the following KQL query to validate that mock API data is flowing in: 
        ...
        {: .warning }Replication can take **10–25 minutes**.
